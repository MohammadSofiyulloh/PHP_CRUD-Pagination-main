    ...
    <body>
        <div class="container">
            <div class="row" id="contentData">
                <div class="col-12">
                    <button type="button" class="btn btn-add btn-success mt-3" value="<?php echo $codeGet; ?>"><i class="bi bi-plus"></i> Tambah Data</button>
                    ...
                    <table id="example2" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="editData.php?id=<?php echo $r['ID'];?>"><button type="button" class="btn btn-add btn-primary mr-2" ><i class="bi bi-pencil"></i></button>Edit</a>
                                    <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="crud.php?act=deleteCity&id=<?php echo $r['ID'];?>"><button type="button" class="btn btn-add btn-danger mr-2"><i class="bi bi-trash"></i></button>Hapus</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
        ...
        <script>
            ...
            $(".btn-add").click(function() {
                var value = $(this).val();
                location.href="tambahData.php?code="+value;
            });
        </script>
