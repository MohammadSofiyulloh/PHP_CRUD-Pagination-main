...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2021 at 08:15 AM
...
(939, 'Jakarta', 'IDN', 'Jaksel', '{\"Population\": 9604900}'),
...
(4081, 'Jakarta', 'IDN', 'Jakarta Raya S', NULL);
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `city_ibfk_1` (`CountryCode`);
